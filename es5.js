...
var Fence = /** @class */ (function () {
    ...
    Fence.prototype.addTask = function (task) {
        ...
        var wrappedTask = function () { return __awaiter(_this, void 0, void 0, function () {
            var result, error_1;
    ...
    Fence.prototype.done = function (needsAll) {
        if (needsAll === void 0) { needsAll = false; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, Promise.all(this.tasks.map(function (f) { return f(); }))];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        error_3 = _a.sent();
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/, this.results];
                }
            });
        });
    };
